...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://img.paulzzh.com/touhou/random", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/qianqianhhh2", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://github.com/qianqianhhh2",
		},
	],
};
